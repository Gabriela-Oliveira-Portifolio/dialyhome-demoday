...
//         const data = await adminService.getDashboardStats();
//         setStats(data);
//       } else if (abaAtiva === 'users') {
//         await carregarUssuarios();
//       } else if (abaAtiva === 'relations') {
//         await carregarVinculacoesMedPac();
//       } else if (abaAtiva === 'audit') {
//         await carregarlogsdeAudt();
//       }
//     } catch (err) {
//       console.error('Erro ao carregar dados:', err);
//       setError(err.error || 'Erro ao carregar dados');
...
//   const carregarVinculacoesMedPac = async () => {
//     try {
//       const data = await adminService.getPatientDoctorRelations();
//       setRelations(data.relations || []);
//     } catch (err) {
...
//   const carregarlogsdeAudt = async () => {
//     try {
//       const data = await adminService.getAuditLogs({ limit: 50 });
//       setAuditLogs(data.logs || []);
//     } catch (err) {
...
//       {/* Navigation Tabs */}
//       <NavigationTabs abaAtiva={abaAtiva} setabaAtiva={setabaAtiva} />
...
//           ) : (
//             <>
//               {abaAtiva === 'dashboard' && <DashboardView stats={stats} />}
//               {abaAtiva === 'users' && (
//                 <UsersView 
//                   users={users}
//                   searchTerm={searchTerm}
...
//                 />
//               )}
//               {abaAtiva === 'relations' && <RelationsView relations={relations} onReload={carregarVinculacoesMedPac} />}
//               {abaAtiva === 'audit' && <AuditView logs={auditLogs} />}
//               {abaAtiva === 'reports' && <ReportsView />}
//               {abaAtiva === 'backup' && <BackupView />}
//             </>
//           )}
//         </div>
//       </main>
...
// const NavigationTabs = ({ abaAtiva, setabaAtiva }) => {
//   const tabs = [
//     { id: 'dashboard', icon: BarChart3, label: 'Dashboard' },
//     { id: 'users', icon: Users, label: 'Usuários' },
//     { id: 'relations', icon: Activity, label: 'Vinculações' },
...
//                           border: 'none',
//                           borderRadius: '6px',
//                           cursor: carregar ? 'not-allowed' : 'pointer',
//                           display: 'flex',
//                           alignItems: 'center',
//                           opacity: carregar ? 0.5 : 1
//                         }}
//                         title="Desvincular médico"
//                       >
//                         <X size={16} />
...
// const AssignDoctorModal = ({ patient, doctors, onClose, onSave, carregar, error }) => {
//   const [selectedDoctor, setSelectedDoctor] = useState(patient.medico_id || '');
//   const [searchDoctor, setSearchDoctor] = useState('');
...
//             type="button"
//             onClick={handleSave}
//             disabled={carregar || !selectedDoctor}
//             style={{
//               flex: 1,
//               padding: '0.75rem',
//               background: carregar || !selectedDoctor 
//                 ? '#d1d5db' 
//                 : 'linear-gradient(90deg, #14b8a6 0%, #10b981 100%)',
//               color: 'white',
//               border: 'none',
//               borderRadius: '10px',
//               cursor: carregar || !selectedDoctor ? 'not-allowed' : 'pointer',
//               fontWeight: '600',
//               fontSize: '0.95rem',
//               display: 'flex',
//               alignItems: 'center',
...
//           style={{
//             padding: '0.75rem 1.5rem',
//             background: carregar ? '#d1d5db' : 'linear-gradient(90deg, #14b8a6 0%, #10b981 100%)',
//             color: 'white',
//             border: 'none',
//             borderRadius: '10px',
//             cursor: carregar ? 'not-allowed' : 'pointer',
...
//           }}
//         >
//           <RefreshCw size={18} style={{ animation: carregar ? 'spin 1s linear infinite' : 'none' }} />
//           {carregar ? 'Processando...' : 'Realizar Backup Agora'}
//         </button>
