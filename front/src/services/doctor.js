...
const API_URL = 'https://dialyhome.com.br/api/doctor';
...
// ===============================
export const sendPatientAlert = async (patientId, alertData) => {
  try {
    const response = await axios.post(
      `${API_URL}/patients/${patientId}/alert`,
      alertData,
      { headers: getAuthHeader() }
    );
    return response.data;
...
// Enviar alerta para paciente
// ===============================
export const sendAlertToPatient = async (patientId, alertData) => {
  try {
    const response = await axios.post(
      `${API_URL}/patients/${patientId}/alert`,
      alertData,
