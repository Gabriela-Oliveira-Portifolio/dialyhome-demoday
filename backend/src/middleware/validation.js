...
const validateDialysisRecord = [
  ...
  body('horario_inicio').matches(/^([01]?\d|2[0-3]):[0-5]\d$/).withMessage('Horário de início inválido'),
...
const validateMedication = [
  ...
  body('horario_principal').matches(/^([01]?\d|2[0-3]):[0-5]\d$/).withMessage('Horário principal inválido'),
  handleValidationErrors
];
